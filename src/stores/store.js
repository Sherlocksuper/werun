...
const header_title_list = Array.from({length: 9}, (v, k) => ({title: header_list[k], checked: false}));
const side_title_list = Array.from({length: 10}, (v, k) => ({title: titles[k], checked: false}));

header_title_list[0].checked = true;
side_title_list[1].checked = true;
